...
print("🚀 Starting Automated Fine-Tuning Pipeline (LARGE)...")
...
print("\n2️⃣  Starting Fine-Tuning LARGE (25 epochs)...")
final_model_path = Path("outputs_trocr_manga_large/final_manga_model")
...
model_dir = Path("outputs_trocr_manga_large/final_manga_model")
...
repo_id = "Remidesbois/trocr-onepiece-fr-large"
api = HfApi()
...
print("\n🎉 Pipeline Completed Successfully! (LARGE model)")
