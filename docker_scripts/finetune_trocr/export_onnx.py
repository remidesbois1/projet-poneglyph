...
MODEL_DIR = "./outputs_trocr_manga/final_manga_model"
...
config["decoder"]["no_repeat_ngram_size"] = 3
config["decoder"]["length_penalty"] = 2.0

with open(config_path, "w", encoding="utf-8") as f:
    json.dump(config, f, indent=2, ensure_ascii=False)
print(f"  ✅ config.json mise à jour (use_cache=true dans le decoder)")
